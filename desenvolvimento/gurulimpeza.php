...
function limpacaracteresutf8 ( $string ) {
	$pattern = array( 'Ã£', 'Ã¡', 'Ã ', 'Ã¢', 'Ã‚', 'Ã€', 'Ã<81>', 'Ãƒ', 'ÃŠ', 'Ãˆ', 'Ã‰', 'Ãª', 'Ã©', 'Ã¨', 'Ã<8d>', 'ÃŒ', 'Ä¨', 'ÃŽ', 'Ã­', 'Ã¬', 'Ã®', 'Ä©', 'Ã´', 'Ãµ', 'Ã³', 'Ã²', 'Ã´', 'Ã”', 'Ã•', 'Ã“', 'Ã“', 'Ã»', 'Ãº', 'Å©', 'Ã¹', 'u', 'Ã›', 'Ãš', 'Ã™', 'Å¨', 'Ã§', 'Ã‡', 'Â°', 'â€“', 'Âº',  'â'.chr(128) );

	$replace = array( 'ã', 'á', 'à', 'â', 'Â', 'À', 'Á', '{§A+TIL§}', 'Ê', 'È', 'É', 'ê', 'é', 'è', 'Í', 'Ì', '&#38;#296;', 'Î', 'í', 'ì', 'î', '&#38;#297;', 'ô', 'õ', 'ó', 'ò', 'ô', 'Ô', 'Õ', 'Ó', 'Ó', 'û', 'ú', '&#38;#361;', 'ù', 'u', 'Û', 'Ú', 'Ù', '&#38;#360;', 'ç', 'Ç', 'º', '-', '°', '"' );
...
function limpacaracteresutf8_novo ( $string ) {
...
function limpacaracteresisolatin1($texto){
